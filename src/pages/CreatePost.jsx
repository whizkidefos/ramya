...
const CreatePost = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
        <div className="">
            <h1 className="mt-2 text-[32px] font-extrabold text-[#222328] max-w-[500px]">Create</h1>
        ...
        <form className="mt-16 mx-w-3xl" onSubmit={handleSubmit}>
            ...
            <div className="mt-5 flex gap-5">
                <button type='button' onClick={generateImage} className="text-white bg-[#143151] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center">
